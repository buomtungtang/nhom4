...
$sql = "SELECT face_name FROM profiles WHERE acc_id = '$accId'";
...
<body>
  ...
  <div class="app-root">
    <div class="homepage">
                          ...
                          <div class="dropdown--content">
                            <div class="item navbar__user--detail">
                              ...
                              <div class="navbar__user--info">
                                <h6 class="displayname"><?php echo $eachName['face_name']; ?></h6>
      ...
      <?php
      $qrOld = "SELECT * FROM posts WHERE post_id = '$postId'";
      $getOld = mysqli_query($connect, $qrOld);
      $oldPost = mysqli_fetch_array($getOld);

      ?>
      <main class="container page__write-post">
        <form action="./process_update.php?idPost=<?php echo $postId; ?>" method="post" enctype="multipart/form-data">
          <div class="grid write-post--container">
            ...
            <div class="title cursor-text" id="write__post--title" contenteditable="true" placeholder="Tiêu đề bài viết......." onkeyup="getTitle(this)">
              <?php if (!empty($oldPost['post_title'])) {
                echo $oldPost['post_title'];
              } ?>
            ...
            <div class="write-post--content">
              <div class="content cursor-text" contenteditable="true" placeholder="Nội dung bài viết" id="write__post--content" onkeyup="getContent(this)">
                <?php if (!empty($oldPost['post_content'])) {
                  echo $oldPost['post_content'];
                } ?>
            ...
            <div class="overlay-front--box">
              <div>
                <div class="post-option">
                  ...
                  <textarea class="input" name="desOfPost" id="#" cols="30" rows="2"><?php if (!empty($oldPost['post_description'])) {
                                                                                        echo $oldPost['post_description'];
                                                                                      } ?></textarea>
                </div>
                <div class="post-option">
                  <p class="overlay-front--title">
                  ...
                  <textarea class="input" name="tag" id="#" cols="30" rows="2"><?php if (!empty($oldPost['post_tag'])) {
                                                                                  echo $oldPost['post_tag'];
                                                                                } ?></textarea>
                </div>
                <div class="post-option">
                  <p class="overlay-front--title">
                  ...
                  <div class="relative">
                    <select class="input  input-se" name="category_id" id="">
                      ...
                      <?php foreach ($result as $each) : ?>
                        <option value="<?php echo $each['category_id']; ?>" <?php if ($oldPost['category_id'] == $each['category_id']) {
                                                                              echo "selected";
                                                                            } ?>>
              ...
              <div class="items-center modal-footer ">
                ...
                <button class="btn btn-primary" type="submit" name="update">Sửa</button>
              </div>
            </div>
          </div>
