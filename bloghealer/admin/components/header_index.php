      ...
      <div class="grid col l-12">
        <div class="row no-gutters navbar__container items-center">
          ...
          <div class="col navbar__item items-center">
            <button aria-label="Search" class="btn--preSearchToggle navbarToggle toggle spr__icon">
      ...
      <div class="col l-12 navbar__categories--wrapper items-center hideOnTablet hideOnMPc hideOnMobile">
        ...
        <div class="items-center relative">
          ...
          <ul class="dropdown navbar__categories--sub">
            ...
            $sqll = "SELECT * FROM categories LIMIT 12 OFFSET 6";
            $resultFake = mysqli_query($connect, $sqll);
            // $rows = mysqli_fetch_array($resultFake);
            // echo count($rows);
            foreach ($resultFake as $eachDrop) :
            ?>
              <li class="item">
                <a href="../../chuyen-muc.php?category=<?php echo  $eachDrop['category_convert']; ?>&id=<?php echo $eachMenu['category_id']; ?>">
                  <?php echo $eachDrop['category_name']; ?>
                </a>
              </li>
            <?php endforeach; ?>
          </ul>
