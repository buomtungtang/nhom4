...
$numberPost = "SELECT COUNT(*) FROM posts WHERE category_id = '$cateId'";
...
$getPost = "SELECT 
    ...
    posts.series,posts.post_description,posts.post_created_at,posts.post_status,posts.post_name,posts.comment_count,
    ...
    WHERE posts.category_id = '$cateId' AND posts.post_status = 'publish'
          ...
          <div class="items-center card-details">
            ...
            <div class="items-center interactions">
              ...
              <a href="#" class="items-center action-commentPost">
                ...
                <span class="amount amount-view"><?php echo $eachPost['view']; ?></span>
              </a>
              <a href="#" class="items-center action-commentPost">
                <span class="spr__icon">
